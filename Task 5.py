...
class ContactManager:
    ...
    def create_widgets(self):
        # Create input fields with new colors
        tk.Label(self.master, text="Name:", bg="#2C3E50", fg="white").pack(pady=5)
        tk.Entry(self.master, textvariable=self.name_var, bg="#ECF0F1", fg="#2C3E50").pack(pady=5)

        tk.Label(self.master, text="Phone:", bg="#2C3E50", fg="white").pack(pady=5)
        tk.Entry(self.master, textvariable=self.phone_var, bg="#ECF0F1", fg="#2C3E50").pack(pady=5)

        tk.Label(self.master, text="Email:", bg="#2C3E50", fg="white").pack(pady=5)
        tk.Entry(self.master, textvariable=self.email_var, bg="#ECF0F1", fg="#2C3E50").pack(pady=5)

        tk.Label(self.master, text="Address:", bg="#2C3E50", fg="white").pack(pady=5)
        tk.Entry(self.master, textvariable=self.address_var, bg="#ECF0F1", fg="#2C3E50").pack(pady=5)

        # Create buttons with new colors
        tk.Button(self.master, text="Add Contact", command=self.add_contact, bg="#1ABC9C", fg="white").pack(pady=5)
        tk.Button(self.master, text="View Contacts", command=self.view_contacts, bg="#1ABC9C", fg="white").pack(pady=5)
        tk.Button(self.master, text="Search Contact", command=self.search_contact, bg="#1ABC9C", fg="white").pack(pady=5)
        tk.Button(self.master, text="Update Contact", command=self.update_contact, bg="#1ABC9C", fg="white").pack(pady=5)
        tk.Button(self.master, text="Delete Contact", command=self.delete_contact, bg="#1ABC9C", fg="white").pack(pady=5)
